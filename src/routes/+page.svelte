...
{#if pageContent}
				...
				<div class="grid gap-8 text-left md:grid-cols-2">
					<div>
						...
						<ul class="space-y-2 text-gray-600">
							{#each pageContent.about?.technicalExpertise || [] as expertise (expertise)}
								<li>• {expertise}</li>
							{/each}
						</ul>
					</div>
					<div>
						...
						<ul class="space-y-2 text-gray-600">
							{#each pageContent.about?.industryFocus || [] as industry (industry)}
								<li>• {industry}</li>
							{/each}
						</ul>
					</div>
	...
	<section class="bg-white py-20">
		<div class="container mx-auto px-4">
			...
			<div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
				{#each Object.entries(pageContent.skills || {}) as [category, skills] (category)}
					<div class="space-y-6">
	...
	<section id="experience" class="bg-gray-50 py-20">
		<div class="container mx-auto px-4">
			...
			<div class="mx-auto max-w-4xl">
				{#each pageContent.experience || [] as exp, index (index)}
					<div
