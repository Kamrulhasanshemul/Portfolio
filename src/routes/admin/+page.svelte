	...
	<div class="container mx-auto max-w-6xl px-4 py-8">
		<div class="mb-8 flex items-center justify-between">
			<div>
				...
				{#if saveMessage}
					<p
						class="text-sm {saveMessageType === 'success' ? 'text-green-600' : 'text-red-600'} mt-1"
					>
						{saveMessage}
					</p>
				{/if}
			...
			<div class="flex gap-4">
				<Button variant="ghost" onclick={refreshContent} disabled={isLoading}>🔄 Refresh</Button>
				{#if isDirty}
				...
				<Button
					...
					class={isDirty ? 'bg-orange-600 hover:bg-orange-700' : ''}
				>
					{#if isLoading}
						⏳ Saving...
					{:else if isDirty}
		...
		<div class="space-y-8">
			...
			<section class="rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-2xl font-semibold">Hero Section</h2>
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
					<div>
						<label for="hero-title" class="mb-1 block text-sm font-medium">Title</label>
						<input
							id="hero-title"
							type="text"
					...
					<div>
						<label for="hero-subtitle" class="mb-1 block text-sm font-medium">Subtitle</label>
						<input
							id="hero-subtitle"
							type="text"
					...
					<div class="md:col-span-2">
						<label for="hero-description" class="mb-1 block text-sm font-medium">Description</label>
						<textarea
							id="hero-description"
					...
					<div class="md:col-span-2">
						<label for="hero-image" class="mb-1 block text-sm font-medium">Profile Image URL</label>
						<input
							id="hero-image"
							type="text"
			...
			<!-- Stats Section -->
			<section class="rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-2xl font-semibold">Statistics</h2>
				<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
					<div>
						<label for="years-experience" class="mb-1 block text-sm font-medium"
					...
					<div>
						<label for="projects-completed" class="mb-1 block text-sm font-medium"
					...
					<div>
						<label for="satisfied-clients" class="mb-1 block text-sm font-medium"
			...
			<!-- About Section -->
			<section class="rounded-lg bg-white p-6 shadow-md">
				<h2 class="mb-4 text-2xl font-semibold">About Section</h2>
				<div class="space-y-4">
					<div>
						<label for="about-description" class="mb-1 block text-sm font-medium">Description</label
						>
						<textarea
					...
					<div>
						<div class="mb-2 flex items-center justify-between">
							...
							<Button size="sm" onclick={() => addToList('about', 'technicalExpertise')}>Add</Button
							>
						</div>
						<div class="space-y-2">
					...
					<div>
						<div class="mb-2 flex items-center justify-between">
							...
							<Button size="sm" onclick={() => addToList('about', 'industryFocus')}>Add</Button>
						</div>
						<div class="space-y-2">
				...
				<div class="space-y-6">
					{#each currentContent.services as service, index}
						<div class="rounded-lg border p-4">
							...
							<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
								<div>
									<label for="service-title-{index}" class="mb-1 block text-sm font-medium"
										>Title</label
									>
									<input
								...
								<div>
									<label for="service-icon-{index}" class="mb-1 block text-sm font-medium"
								...
								<div class="md:col-span-1">
									<label for="service-description-{index}" class="mb-1 block text-sm font-medium"
										>Description</label
									>
									<textarea
										...
										on:input={handleChange}
										class="h-20 w-full rounded border p-2"
									></textarea>
								</div>
							</div>
						</div>
					...
					{#each currentContent.projects as project, index}
						<div class="rounded-lg border p-4">
							...
							<div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									<label for="project-title-{index}" class="mb-1 block text-sm font-medium"
										>Title</label
									>
									<input
								...
								<div>
									<label for="project-impact-{index}" class="mb-1 block text-sm font-medium"
										>Impact</label
									>
									<input
								...
								<div>
									<label for="project-link-{index}" class="mb-1 block text-sm font-medium"
										>Link</label
									>
									<input
								...
								<div>
									<label for="project-image-{index}" class="mb-1 block text-sm font-medium"
										>Image URL</label
									>
									<input
							...
							<div class="mb-4">
								<label for="project-description-{index}" class="mb-1 block text-sm font-medium"
									>Description</label
								>
								<textarea
							...
							<div>
								<div class="mb-2 flex items-center justify-between">
									<label for="project-technologies-{index}" class="block text-sm font-medium"
										>Technologies</label
									>
									<Button size="sm" onclick={() => addTechnology(index)}>Add Technology</Button>
								</div>
								<div class="space-y-2">
									...
									<div class="grid grid-cols-1 items-center gap-4 md:grid-cols-3">
										...
										<div class="flex items-center gap-2">
											<input
												...
												class="flex-1"
											/>
											<span class="w-12 text-sm">{skill.level}%</span>
										</div>
										<Button
											size="sm"
											variant="destructive"
				...
				<div class="space-y-6">
					{#each currentContent.experience as exp, index}
						<div class="rounded-lg border p-4">
							...
							<div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2">
								<div>
									<label for="exp-company-{index}" class="mb-1 block text-sm font-medium"
										>Company</label
									>
									<input
								...
								<div>
									<label for="exp-position-{index}" class="mb-1 block text-sm font-medium"
										>Position</label
									>
									<input
								...
								<div>
									<label for="exp-period-{index}" class="mb-1 block text-sm font-medium"
										>Period</label
									>
									<input
										id="exp-period-{index}"
								...
								<div>
									<label for="exp-location-{index}" class="mb-1 block text-sm font-medium"
										>Location</label
									>
									<input
							...
							<div class="mb-4">
								<label for="exp-description-{index}" class="mb-1 block text-sm font-medium"
									>Description</label
								>
								<textarea
							...
							<div>
								<div class="mb-2 flex items-center justify-between">
									<label for="exp-achievements-{index}" class="block text-sm font-medium"
										>Achievements</label
									>
									<Button size="sm" onclick={() => addAchievement(index)}>Add Achievement</Button>
								</div>
								<div class="space-y-2">
			...
			<section class="rounded-lg bg-white p-6 shadow-md">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
					...
					<div>
						<label for="contact-phone" class="mb-1 block text-sm font-medium">Phone</label>
						<input
							id="contact-phone"
							type="text"
					...
					<div>
						<label for="contact-location" class="mb-1 block text-sm font-medium">Location</label>
						<input
							id="contact-location"
							type="text"
					...
					<div>
						<label for="contact-github" class="mb-1 block text-sm font-medium">GitHub URL</label>
						<input
							id="contact-github"
							type="text"
					...
					<div class="md:col-span-2">
						<label for="contact-linkedin" class="mb-1 block text-sm font-medium">LinkedIn URL</label
						>
						<input
							id="contact-linkedin"
							type="text"
